  ...
  return (
    <footer className="bg-primary text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/80 text-sm">
              ...
              <li className="pt-2">
                <a href="mailto:info@hitechedu.org" className="flex items-center hover:text-white transition-colors">
        ...
        <div className="border-t border-white/10 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-white/60">
